      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-blue-800">AI-UBISD Vehicle Intelligent System</h1>
            <p className="text-gray-500 mt-1">ระบบขอใช้รถยนต์ราชการอัจฉริยะ สพร.7 อุบลราชธานี</p>
          </div>
